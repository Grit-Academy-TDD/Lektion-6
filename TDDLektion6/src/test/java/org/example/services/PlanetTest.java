...
class PlanetTest {
    ...
    public void shouldDieIfTempIsLowerThanMinus30(double temp) {
    ...
    @ParameterizedTest
    @ValueSource(doubles = {-40.2, -33.2, -90.4, -293.1})
    public void shouldDieIfOxygenIsLowerThan20Percent(double oxygenRate) {
        Sheep sheep = new Sheep(planet);
    ...
    @ParameterizedTest
    @ValueSource(doubles = {40.2, 33.2, 90.4, 82.1})
    public void shouldSurviveIfOxygenIsHigherThan20Percent(double oxygenRate) {
        Sheep sheep = new Sheep(planet);
        when(planet.getOxygenRate()).thenReturn(oxygenRate);
        boolean actual = sheep.isDead();
    ...
    @Test
    public void shouldDieIfThereIsKillerSnails() {
        Sheep sheep = new Sheep(planet);
